...
class DrudeModelDC(object):
    ...
    def calc_copmlexconductivity(self):
    ...
    def calc_currentdensity(self, electricfield):
        return DrudeModelDC.calc_copmlexconductivity(self) * electricfield
...
def _example():
    ...
    print('complex conductivity', wire.calc_copmlexconductivity())
