...
def _example():
    ...
    e1 = JosephsonJunction.energy_zeeman(gl=1, L=0, gs=2, S=1/2, B=np.linspace(0,1, 1001), E_offset=0)
    e2 = JosephsonJunction.energy_zeeman_simple(ms=1, ge=2,  B=np.linspace(0, 1, 1001), E_offset=0)
